...
public class Execution {
  ...
  public static void main(String[] args) throws Exception {
    ...
    List<Thread> urlRunningThreads = urlConsumers.stream().map(Thread::new).peek(Thread::start).collect(Collectors.toList());

    try (InputStream fileInput = new BufferedInputStream(new FileInputStream("src/main/resources/urls"))) {
